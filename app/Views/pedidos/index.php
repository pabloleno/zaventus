        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h6 class="m-0 text-dark"><i class="fas fa-list"></i> <?= (isset($ultimos_cinco)) ? "Cinco últimos pedidos cadastrados" : "Registros" ?></h6>
                        </div><!-- /.col -->
                    </div>
                </div>
                <!-- /.card-header -->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h6><b>Critérios:</b> <?= (isset($id_orcamento)) ? "Cód. do Pedido=$id_orcamento" : "" ?><?= (isset($data_inicio)) ? " | Data Inicio=$data_inicio e Data Final=$data_final" : "" ?><?= (isset($id_cliente)) ? " | Cód. do Cliente=$id_cliente" : "" ?></h6>
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
