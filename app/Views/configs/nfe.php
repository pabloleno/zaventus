                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            Cupom nao fiscal permanece como fluxo principal de venda. Esta configuracao deixa a NFe preparada para testes em homologacao no Amazonas: tpAmb=2, cUF=13 e cMunFG=1302603. Antes de emitir, substitua CNPJ, IE, certificado, senha e dados fiscais dos produtos pelos dados reais da empresa.
                        </div>
                        <div class="row">
                            <div class="col-lg-3">
